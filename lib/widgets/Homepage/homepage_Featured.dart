...
class HomePageFeatured extends StatefulWidget {
  @override
  _HomePageFeaturedState createState() => _HomePageFeaturedState();
}

class _HomePageFeaturedState extends State<HomePageFeatured> {
  @override
